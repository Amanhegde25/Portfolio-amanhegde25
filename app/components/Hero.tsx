...
export default function Hero() {
  return (
    <section id="home" className="relative flex min-h-screen items-center justify-center overflow-hidden px-6 pb-16 pt-32">
      ...
      <div className="mx-auto max-w-4xl text-center">
        ...
        <div className="mt-11 flex items-center justify-center gap-6 text-sm font-medium text-muted">
          <a href={profile.github} target="_blank" rel="noopener noreferrer" className="transition hover:text-foreground hover:underline underline-offset-4 decoration-accent">
            GitHub
          </a>
          <a href={profile.linkedin} target="_blank" rel="noopener noreferrer" className="transition hover:text-foreground hover:underline underline-offset-4 decoration-accent">
            LinkedIn
          </a>
          <a href={`mailto:${profile.email}`} className="transition hover:text-foreground hover:underline underline-offset-4 decoration-accent">
            Email
          </a>
        </div>
      </div>
